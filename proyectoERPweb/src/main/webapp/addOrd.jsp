...
<%@page import="edu.fpdual.proyectoERP.pdf.GenerarPdf2"%>
	...
	<main>
		...
		<section class="mt-5 section text-center py-5">
			<div class="pt-5 "
				...
				<span style="font-size: 4em; color: #ed8323">¡Pedido añadido!</span>
			</div>
		...
		<section class="section ">
			...
			<div class="text-center"
				...
				<a class="btn botoncta2 btn-rounded"
					href="C:\Users\pablo.villar.serrano\Desktop\pruebaBuena2.pdf"
					download="" target="_self" style="float: none"> DESCARGAR PEDIDO 
				</a>
			</div>
		</section>
