	...
	<main>
		...
		<section class="section py-5" >
			...
			<div class="p-4 text-center" style="text-align: center; ">
				<input type="text" id="myInputOrdID" onkeyup="myFunctionOrdID()" placeholder="Buscar por Id Pedido" title="Escribe un Id Pedido">
				<input type="text" id="myInputEmpID" onkeyup="myFunctionEmpID()" placeholder="Buscar por Id Empleado" title="Escribe un Id Empleado">	
				<input type="text" id="myInputCustID" onkeyup="myFunctionCustID()" placeholder="Buscar por Id Cliente" title="Escribe un Id Cliente">	
				<input type="text" id="myInputDATE" onkeyup="myFunctionDATE()" placeholder="Buscar por Fecha" title="Escribe una fecha">	
			</div>	   
			       ...
			       <% for(Order ord:list){ %>
			           ...
			           <tr>
			               ...
			               <td><%= ord.getOrderDate()%></td>
   			               <td>
						   	<a href="deleteEmp.jsp?id= <%=ord.getOrderID() %>">
