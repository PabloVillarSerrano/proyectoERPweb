		...
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-body" style="text-align: center;">
					...
					<div>
						<h2>
							Update del cliente con Id: <span id="modalId"></span>
						</h2>
					</div>

					<div class="pt-4">
						<form name="updateCust" action="updateCust.jsp" method="GET">
							<label class="px-2"> Id </label><input type="text"
								name=CustomerId value="<%=request.getParameter("CustomerId")%>" />
							<br> <label class="px-2"> Compañia </label><input
								type="text" name="Company" value="" /> <br> <label
								class="px-2"> Nombre </label><input type="text" name="FirstName"
								value="" /> <br> <label class="px-2"> Apellido </label><input
								type="text" name="LastName" value="" /><br> <input
								type="submit" value="Actualizar cliente" />
						</form>
					</div>
	...
	<main>
		...
		<section class="section py-5">
			...
			<div class="p-4 text-center" style="text-align: center;">
				<input type="text" id="myInputID" onkeyup="myFunctionID()"
					placeholder="Buscar por Id" title="Escribe un id"> <input
					type="text" id="myInputCOMPANY" onkeyup="myFunctionCOMPANY()"
					placeholder="Buscar por Compañía" title="Escribe una compañía">
				<input type="text" id="myInputNAME" onkeyup="myFunctionNAME()"
					placeholder="Buscar por Nombre" title="Escribe un nombre">
				<input type="text" id="myInputLASTNAME"
					onkeyup="myFunctionLASTNAME()" placeholder="Buscar por Apellido"
					title="Escribe un apellido">
			...
			<div class="" style="text-align: center">
				...
				<table border="1" style="margin: auto" id="myTable">
					...
					<tbody>
						...
						<tr>
							<td><%=cust.getCustomerId()%> <input
								id="CustomerId<%=cust.getCustomerId()%>" type="hidden"
								value="<%=cust.getCustomerId()%>" /></td>
							...
							<td><span> <!-- funcion js -->
									...
									<button type="button" class="update" data-toggle="modal"
										data-target="#carouselIMG"
										onClick="idModal(<%=cust.getCustomerId()%>)">Update</button>



							</span><a href="deleteCust.jsp?id=<%=cust.getCustomerId()%>">
				...
				<div class="pt-4">
					<form name="addCust" action="addCust.jsp" method="GET">
						<label class="px-2"> Id </label><input type="text" name=CustomerId
							value="" /> 
							<label class="px-2"> Compañia </label><input
							type="text" name="Company" value="" /> 
							<label class="px-2">
							Nombre </label><input type="text" name="FirstName" value="" /> 
							<label class="px-2"> Apellido </label><input type="text" name="LastName"
							value="" /> 
